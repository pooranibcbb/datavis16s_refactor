---
title: "datavis16s R package README"
output:
   md_document:
...
graphs. See [user
doc](https://github.niaid.nih.gov/bcbb/nephele2/blob/master/pipelines/datavis16s/doc/user_doc.rst)
for more info.
...
-   To build the package along with the user and package documentation,
    ...
    manual](doc/Reference_Manual_datavis16s.md) and the [user docs](doc/user_doc.rst)
