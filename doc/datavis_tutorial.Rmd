...
<edit_text_plotly.mp4>
- The legend can also be edited, and can be moved by clicking and dragging.
<edit_legend_plotly.mp4>
- To save the plot, click on the camera icon in the menu.  The browser will download the png file.
<save_plotly_whole.mp4>
- To edit the graph further, you can export the data to Plotly Chart Studio by clicking on "Export Data to Plotly."  See the [Plotly Chart Studio tutorials](https://plot.ly/online-chart-maker/) for more information.
...
<heatmap_taxlevel.mp4>

### Sort the heatmap by taxonomic level

1. Select View > Options > Annotations > Row Annotations > taxonomic level > Close.  This will show a column with the taxonomic level annotations for the heatmap.
