  ...
  var exploding_boxplot = function(data,aes)
  {
    ...
    var textWidth = d3.max(groups.map(function(d){return d.key.length}));
    height = height + 11*textWidth/2;
    margin = {top:10,bottom:50+(11*textWidth/2),left:50,right:10};
    xlabeldy = 0.7*(textWidth/2) + "em";
